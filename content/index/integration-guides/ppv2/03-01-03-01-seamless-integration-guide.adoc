...
Payment processing with {payment-page-v2} in Seamless Mode deviates a little bit from the <<PaymentPageSolutions_PPv2_HPP_Integration, HPP>> and <<PaymentPageSolutions_PPv2_EPP_Integration, EPP>> payment processing workflow:
