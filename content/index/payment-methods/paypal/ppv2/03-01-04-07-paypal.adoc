...
|merchant-account-id m|value |String |Mandatory |36 |A unique identifier
...
.2+|requested-amount m|value |Numeric |Mandatory |18 a|The full amount that is
...
as a parent.
.6+|shipping 2+m|last-name |String |The last name of the shipping address.
2+|first-name |String |The first name of the shipping address.
.4+|address m|street1 |String |The first line of the shipping address street.
...
|payment-methods m|payment-method m|name |String |The name of the payment method
...
.2+|requested-amount 2+m|currency |String a|The currency of the requested/contested transaction amount.

Format: 3-character abbreviation according to ISO 4217.
2+|value |Numeric |The full amount that is requested/contested in a transaction. 2 decimals allowed.
.4+|statuses .4+m|status m|description |String |The description of the transaction status message.
...
2+|merchant-account-id m|value |String |A unique identifier assigned to every merchant account (by {payment-provider-name}).
...
.3+|account-holder 2+m|last-name |String |The last name of the account holder.
...
|country |String |The country ID part of the shipping address.
3+|account-id |String |Account holder's _PayPal_ Wallet identifier.
|payment-methods m|payment-method m|name |String |The name of the payment method used for the transaction.
...
|merchant-account-id m|value |String |Mandatory |36 |A unique identifier assigned
...
Format: 3-character abbreviation according to ISO 4217.
|payment-method m|name |String |Optional |15 |The name of the
payment method used for the transaction. Set this value to ``paypal``.
.2+|periodic m|periodic-type |String |Conditional |9 |Mandatory for recurring
...
|payment-methods m|payment-method m|name |String |The name of the payment method
used for the transaction.
.2+|periodic 2+m|periodic-type |String |Indicates if (and how) payment occurs more
than once.
...
Format: YYYY-MM-DDThh:mm:ss (ISO).
.2+|requested-amount 2+m|currency |String a|The currency of the
requested/contested transaction amount.

Format: 3-character abbreviation according to ISO 4217.
2+|value |Numeric |The full amount that is requested/contested in a transaction. 2 decimals allowed.
.4+|statuses .4+m|status m|description |String |The description of the
...
2+|merchant-account-id m|value |String |A unique identifier assigned to every
...
|postal-code |String |The postal code/ZIP of the shipping address.
|country |String |The country ID part of the shipping address.
|wallet 2+m|account-id |String |Account holder's _PayPal_ wallet identifier.
|payment-methods m|payment-method m|name |String |The name of the payment method
used for the transaction.
3+|transaction-id |String |A unique identifier assigned to every transaction
(by {payment-provider-name}). Used when searching for or referencing to it later.
