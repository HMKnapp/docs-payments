...
include::{root}/include/fields/rest_cc/response/res-installment-plan-options.adoc[]
...
include::{root}/include/fields/rest_cc/response/res-available-installment-plan-options.adoc[]
