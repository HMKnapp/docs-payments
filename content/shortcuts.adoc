...
:instance-hostname: payments.wirecard.com
:test-instance-hostname: payments-test.wirecard.com
:pp-test-instance-hostname: payments-test.wirecard.com/
...
:pp-test-endpoint: {pp-test-instance-hostname}/wpp/api/payment/register

 	
https://payments-test.wirecard.com/wpp/api/payment/register
