...
[#CC_Fields_xmlelements_response_installmentPlanOptions]
...
include::{root}/include/fields/rest_cc/response/req-installment-plan-options.adoc[]

|===


[#CC_Fields_xmlelements_response_ availableInstallmentPlanOptions_installmentPlanOption]
...
include::{root}/include/fields/rest_cc/response/req-available-installment-plan-options.adoc[]
