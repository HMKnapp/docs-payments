...
[%autowidth, cols="h,"]
|===
| URL(s) Endpoints           | ``\https://{pp-test-endpoint}``
...
A purchase transaction charges the account holder's card and immediately
...
[%autowidth, stripes=none, cols="m,,,a,,"]
|===
2+h|Field (JSON) 
h|Data +
Type 
...
[%autowidth, stripes=none, cols="m,,a,a,,"]
|===
2+h|Field (JSON) 
h|Data +
Type 
...
An authorization-only transaction verifies the validity of account
...
post processing operations - like a refund of one of your debit transactions 
...
(ECI Value: 07 - VISA, 00 - Mastercard)
...
[%autowidth,  stripes=none, stripes="none", cols="m,,,,,,,,a"]
|===
5+|JSON |Datatype |<<PPv2_CC_3DS2Fields_ROC, M/O>> |Size |Description

.2+|card

4+m|merchant-tokenization-flag
|Boolean
|M
|
