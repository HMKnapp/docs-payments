...
For the payment method _Credit Card_ we provide special card numbers for Mastercard and VISA to test a variety of status codes.
...
| 500.3115 | warning     | External Provider: CVV must be 3 digits. | External Provider: CVV must be 3 digits.
